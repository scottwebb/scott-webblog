...
const NavCategory = ({ category }) => {
  return (
    <NavContainer>
      <NavControls>
          <NavLink to={`/blog`} title={`All articles`} activeClassName="active" >
          All
          </NavLink>
          <NavLink to={`/categories/showcase`} title={`Showcase category`} activeClassName="active" >
          Showcase
          </NavLink>
          <NavLink to={`/categories/architecture`} title={`Architecture Photography category`} activeClassName="active" >
          Architecture
          </NavLink>
          <NavLink to={`/categories/business`} title={`Photography Business category`} activeClassName="active" >
          Business
          </NavLink>
